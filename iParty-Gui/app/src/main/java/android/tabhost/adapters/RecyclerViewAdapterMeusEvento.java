...
import android.tabhost.EditarEvento;
 ...
 */
public class RecyclerViewAdapterMeusEvento extends RecyclerView.Adapter<RecyclerViewAdapterMeusEvento.ViewHolder> {
    ...
    Object mContext;
    public RecyclerViewAdapterMeusEvento(List<GetDataAdapter> getDataAdapter, Activity context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_meuseventos, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder Viewholder, final int position) {
        ...
        Viewholder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                EditarEvento frag = new EditarEvento();
